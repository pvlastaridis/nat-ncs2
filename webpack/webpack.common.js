    ...
    return {
        ...
        plugins: [
            ...
            new CopyWebpackPlugin([
                ...
                { from: './src/main/webapp/pviz-bundle.js', to: 'pviz-bundle.js' },
                { from: './src/main/webapp/SERVER_NCS2.pl', to: 'SERVER_NCS2.pl' },
                { from: './src/main/webapp/images', to: 'images' },
                { from: './src/main/webapp/results', to: 'results' },
                { from: './src/main/webapp/hmmrResults', to: 'hmmrResults' },
                { from: './src/main/webapp/hmmrUploads', to: 'hmmrUploads' }
            ]),
            ...
            new MergeJsonWebpackPlugin({
                output: {
                    groupBy: [
                        ...
                        { pattern: "./src/main/webapp/i18n/el/*.json", fileName: "./target/www/i18n/el/all.json" }
