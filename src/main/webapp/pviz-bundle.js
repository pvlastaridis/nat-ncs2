...
define(
    ...
    'pviz/views/FeatureDisplayer',['jquery', 'underscore', 'backbone', 'd3', './TypedDisplayer', '../utils/GGplot2Adapter'], function ($, _, Backbone, d3, typedDisplayer, ggplot2Adapter) {
        ...
        var defaultPositioner = function (viewport, d3selection) {
            ...
            var ftWidth2 = function (ft) {
                return (viewport.scales.x(ft.end + 0.9) - viewport.scales.x(ft.start + 0.1))/2-6
            }
            // panos for height changed below from 0.76 to 1.76
            d3selection.selectAll("rect.feature").attr('width', ftWidth).attr('height', hFactor * viewport.scales.y(1.76));
            ...
            }).attr('height', viewport.scales.y(hFactor * 1.76));

            var fontSize = 19 * hFactor;
            // self.fontSizeLine();
            ...
            }).attr("y", function(d) { return 15.0; }).attr("x", ftWidth2).style('font-size', fontSize).style('font-weight', 'bold');
            return d3selection
        }
    ...
    function ($, _, Backbone, d3, featureManager, featureDisplayer, SeqEntryViewport, FeatureLayer, FeatureLayerView, HiddenLayersView, DetailsPane, tmpl) {
        ...
        var SeqEntryAnnotInteractiveView = Backbone.View.extend(/** @lends module:SeqEntryAnnotInteractiveView~SeqEntryAnnotInteractiveView.prototype */{
            ...
            initialize: function (options) {
                ...
                $(self.el).empty();
                var el = $(tmpl);
                $(self.el).append(el) //Append to self a DOM element tmpl defined just before view
        ...
        var OneLiner = bb.View.extend(/** @lends module:OneLiner~OneLiner.prototype */{
            ...
            render: function () {
                ...
                self.svg.selectAll('rect').attr('x', function (ft) {
                    ...
                    return 'subline-' + ft.classt
                }).append('title').text(function (ft) {
                            return ft.description;
                        });
            }
        });
